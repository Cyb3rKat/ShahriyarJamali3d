    ...
    return (
        <div className='bg-[#E8E7E7] min-h-screen flex flex-col items-center justify-center'>
            <div className='bg-[#EAEAEA] flex flex-col items-center grow justify-center w-full h-full '>
                ...
                <h1 className='text-2xl md:text-5xl leading-relaxed'>Hi , Im Shahriyar Jamali</h1>
                ...
                <div className='space-x-10 flex mt-10'>
                    <div className='w-10 h-10'><Image src={dribbbleIcon} alt={'test'}
                        className='bg-black p-5 rounded-full relative text-white fill-white' /></div>
                    <div className='w-10 h-10'><Image src={dribbbleIcon} alt={'test'} className='bg-black p-5 rounded-full relative text-white fill-white' /></div>
                    <div className='w-10 h-10'><Image src={dribbbleIcon} alt={'test'} className='bg-black p-5 rounded-full relative text-white fill-white' /></div>
