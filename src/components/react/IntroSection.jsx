...
const IntroSection = () => {
    return (
        <div id="intro" className='bg-jamali-black scroll-smooth flex flex-col items-center justify-center w-full  min-h-screen'>
            <Image src={mylogo} width={150} className='mb-10 grayscale bg-white rounded-full p-4' alt='mylogo' />
            <h1 className={` ${raleway.className} text-2xl md:text-5xl leading-relaxed md:leading-loose font-semibold uppercase text-white`}>Shahriyar Jamali</h1>
            ...
            <div className='flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-10 mt-10'>
                <Link className='text-center border-white text-white border-2 px-4 text-sm md:px-10 py-2  rounded-md' href={'#about'}>Read more about me</Link>
                <Link className='bg-white text-sm px-4 md:px-10 py-2  text-black rounded-md' href={'/3d'}>Take a 3D tour of my Art Gallery</Link>
            </div>
